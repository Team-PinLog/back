...
| 2026-07-27 | (Task 1) `ApiResponse<T>` 공통 봉투 레코드 추가, 운영 Jackson 3 매퍼로 JSON 검증 (`a45475a`, `93f4ad6`, S15P11A705-53) | [BD-03](decisions/BD-03-api-response-envelope.md) · [BI-03](implements/BI-03-2026-07-27-api-response-envelope.md) |
...
| 2026-07-27 | (Task 5) `ApiResponseOpenApiCustomizer`(springdoc `OperationCustomizer`)로 `/v3/api-docs` 2xx 스키마에도 봉투 반영, BD-03·BI-03 정정 (S15P11A705-53) | [BD-03](decisions/BD-03-api-response-envelope.md) · [BI-03](implements/BI-03-2026-07-27-api-response-envelope.md) |
