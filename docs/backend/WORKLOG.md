...
| 2026-07-27 | SIGTERM graceful shutdown 활성화(기본값 `immediate`였음) + 종료 타임아웃 20s를 k8s `terminationGracePeriodSeconds` 40s와 짝지어 결정. liveness·readiness probe 계약 테스트 추가, `database-conventions.md`에 backward-compatible migration 규약 신설 (S15P11A705-51) | [BD-04](decisions/BD-04-graceful-shutdown-timing.md) · [BI-04](implements/BI-04-2026-07-27-graceful-shutdown.md) |
