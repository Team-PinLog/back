...
3. Read `docs/backend/spec/` for the domain you are touching, plus the recent entries in `docs/backend/WORKLOG.md`. If you are about to overturn a decision already made, read the matching record in `docs/backend/decisions/` first.
