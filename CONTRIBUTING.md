...
- 사용하지 않는 빈 패키지, `.gitkeep`, 추측성 도메인 계층을 만들지 않습니다.
...
세부 기준은 [API 규약](docs/development/api-conventions.md), [데이터베이스 규약](docs/development/database-conventions.md), [테스트 규약](docs/development/testing-conventions.md)을 따릅니다.
