...
세부 기준은 [패키지 구조 규약](docs/development/package-structure.md), [API 규약](docs/development/api-conventions.md), [데이터베이스 규약](docs/development/database-conventions.md), [테스트 규약](docs/development/testing-conventions.md)을 따릅니다.
